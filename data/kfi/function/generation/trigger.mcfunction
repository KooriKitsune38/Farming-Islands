...
execute if entity @e[type=marker,tag=kfi.Spawn] unless score .noGeneration kfi.IslandUUIDs matches 1 run function kfi:generation/position_generator with storage kfi:values generatorPos
