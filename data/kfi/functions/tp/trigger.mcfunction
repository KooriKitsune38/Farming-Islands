...
# Check type
    ...
    #> Sending
    execute unless entity @s[gamemode=spectator] if score @s tp matches 1.. unless score @s kfi.teleportTimer matches 0.. unless score @s kfi.teleportUUID matches -2147483648..2147483647 if score @s kfi.IDs matches -2147483648..2147483647 run function kfi:tp/sending
