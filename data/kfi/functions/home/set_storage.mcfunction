...
$execute if data storage kfi:values coopIslands[{UUID:$(tempUUID)}] run data modify storage kfi:values coopIslands[{UUID:$(tempUUID)}].homePos set from storage kfi:values players[{UUID:$(tempUUID)}].homePos